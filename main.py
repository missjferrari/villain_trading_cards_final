...
def get_endpoints():
  endpoints = {"/api/villians": "GET - Retrieves all villain data from the databse", "/api/villains/delete": "POST - Removes a single villain from the database", "/api/villains/add": "POST - Adds a single villain to the database"}
